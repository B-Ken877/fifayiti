      ...
      <div className="flex-1 flex items-center justify-center px-4 pb-12">
        <div className="w-full max-w-sm">
          ...
          <div className="text-center mb-6">
            <div className="w-14 h-14 rounded-2xl bg-[#F4C400] flex items-center justify-center mx-auto mb-3">
              <Flame size={28} className="text-[#064E2A]" />
            </div>
            <h1 className="text-2xl font-black text-white tracking-tight">PARIAJ</h1>
